...
run_child_suite "tests/test-bl263-uat-scenario-escaping.sh" \
  "BL-263: UAT scenario text is escaped into innerHTML, not concatenated raw" \
  "BL-263 scenario-escaping tests FAILED (run tests/test-bl263-uat-scenario-escaping.sh for details)"
